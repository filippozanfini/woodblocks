...
@Id("block")
public class DraggableNodeL290 extends DraggableNode {  
    ...
    public DraggableNodeL290() {
        ...
        this.setScore(5);
        this.setView(new ImageView(new Image("/assets/Blocks/"+"L2_90"+".png", 150, 150, false, false)));
    ...
    public boolean setColor(GridPane gameMatrix, boolean conferma) {
        ...
        if(!checkAvailability(x, y) || !checkAvailability(x+1, y) || !checkAvailability(x+2, y) || !checkAvailability(x, y+1) || !checkAvailability(x, y+2)) {
    ...
    private void mostraAnteprima(GridPane gameMatrix, int x, int y) {
        ...
        gameMatrix.add(rectangle5,x, y+2);
    }
