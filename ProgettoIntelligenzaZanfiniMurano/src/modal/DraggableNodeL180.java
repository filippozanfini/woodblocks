...
public class DraggableNodeL180 extends DraggableNode {
    ...
    public DraggableNodeL180() {
        ...
        this.setScore(4);
        this.setView(new ImageView(new Image("/assets/Blocks/"+"L180"+".png", 150, 150, false, false)));
    ...
    public boolean setColor(GridPane gameMatrix, boolean conferma) {
        ...
        if(!checkAvailability(x, y) || !checkAvailability(x+1, y) || !checkAvailability(x+1, y+1) || !checkAvailability(x+1, y+2)) {
        ...
        if(conferma) {
            rimuoviAnteprima(gameMatrix);
            if(GameMatrix.checkAvailability(x, y) && GameMatrix.checkAvailability(x+1, y) && GameMatrix.checkAvailability(x+1, y+1) && GameMatrix.checkAvailability(x+1, y+2)) {
